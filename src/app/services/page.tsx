  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        /* ── Design: intense shake/roar then float ── */
        ...
        /* ── Web: exaggerated space float with horizontal drift ── */
        ...
        /* ── IA: pendulum wave from bottom center ── */
        @keyframes iaWave {
        ...
        /* ── Apps: continuous aggressive flip attempts ── */
        @keyframes appFlip {
